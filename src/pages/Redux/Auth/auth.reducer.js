...
export const authReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SEARCH_USER_REQUEST: // Added
    ...
    case SEARCH_USER_SUCCESS: // Added: This puts results into searchUser
    ...
    case SEARCH_USER_FAILURE: // Added
